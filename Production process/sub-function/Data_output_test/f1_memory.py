...
def update_telemetry_state(telemetry_dict):
    global LATEST_PACKET_STATE
    with state_lock:
        LATEST_PACKET_STATE["telemetry"] = telemetry_dict

def update_motion_state(motion_dict):
    global LATEST_PACKET_STATE
    with state_lock:
        LATEST_PACKET_STATE["motion"] = motion_dict
